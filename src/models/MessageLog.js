 ...
 *
 * `template` names the message kind so the UI can group/count by it:
 *   reengage | appointment_24h | appointment_2h | custom
 */
const messageLogSchema = new mongoose.Schema(
  {
    ...
    template: { type: String, enum: ['reengage', 'birthday', 'followup', 'appointment_24h', 'appointment_2h', 'custom'], default: 'custom' },
